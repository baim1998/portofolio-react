function Home() {
  ...
  <div id="intro-nav">
  <div id="about-nav">
    <h4 id="hello"> Hello Welcome</h4>
    <h1 id="name">I'am Baim <br />
  ...
  <div id="text-navbar">
    <div>
    <h2 id="header2">What can i do</h2>
    </div>
    <div id="aboutme-nav">
     <p id="paragraf">I am a beginner who has entered the world of frontend developer,<br /> 
      you can see from my very simple portfolio, <br />
     but I am still trying to make it better in the future. </p>
    </div> 
  </div>
    <div id="box">
    <div id="iconweb">
   ...
   <div id="baground">
    <h1 style={{fontFamily:'roboto,sans-serif',fontWeight:'600',fontSize:'25px', textAlign:"center",paddingTop:'20px'}}>About me</h1>
    ...
    <div id="nav-end">
      ...
      <div id="logo-text">
        <p style={{marginTop:'10px',color:'white'}}>help me to be more enthusiastic in developing <br />
          other ideas
        </p>
        <br />
